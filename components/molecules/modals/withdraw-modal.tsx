...
export function WithdrawModal({ open, onOpenChange }: WithdrawModalProps) {
  ...
  return (
    <ModalLayout
      ...
      description="Transfer available wallet balance to your USDT address."
      size="md"
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 pt-1">
          ...
          <div className="flex items-start gap-3 rounded-xl border border-slate-800 bg-slate-900/50 p-3.5 text-xs text-slate-300">
            ...
            <div>
              <p className="font-semibold text-white">Secure USDT Withdrawal</p>
              <p className="text-[11px] text-slate-400 mt-0.5">
                Double-check your address and network before submitting. Crypto
